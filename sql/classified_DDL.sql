...
-- Update the table name to POST_DETAILS instead of ITEM_DETAILS
-- Add Post_image table and link with post_details table
-- T_ITEM_IMAGES:
-- ITEM_ID (Foreign Key from T_ITEM_DETAILS)
-- IMAGE_LOCATION (Item image location)
-- Add col to identify post type (buy /sell)
-- Add col to approve / reject
-- Add col approver Id
-- Add col approver comments
